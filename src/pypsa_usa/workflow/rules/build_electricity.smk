...
rule build_base_network:
    ...
    input:
        ...
        reeds_shapes=RESOURCES + "{interconnect}/Geospatial/reeds_shapes.geojson",
        county_shapes=RESOURCES + "{interconnect}/Geospatial/county_shapes.geojson",
        reeds_memberships=get_repo_data_path("ReEDS_Constraints/membership.csv"),
    output:
...
rule build_cost_data:
    ...
    input:
        efs_tech_costs=get_repo_data_path("costs/EFS_Technology_Data.xlsx"),
        efs_icev_costs=get_repo_data_path("costs/efs_icev_costs.csv"),
        eia_tech_costs=get_repo_data_path("costs/eia_tech_costs.csv"),
        egs_costs=get_repo_data_path("costs/egs_costs.csv"),
        additional_costs=get_repo_data_path("costs/additional_costs.csv"),
    output:
...
def demand_raw_data(wildcards):
    ...
    if profile == "eia":
        ...
        return [
            ...
            get_repo_data_path("sectors/transport_ratios.csv"),
        ]
