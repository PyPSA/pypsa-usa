...
# coding: utf-8
"""
Building Multi-period Network from Breakthrough Energy Zenodo Repository
...
def base_network(
    ...
    #Loading csv file data for each component type
...
if __name__ == "__main__":
    if "snakemake" not in globals():
        ...
        snakemake = mock_snakemake("base_network", **{'interconnect':'western'})
