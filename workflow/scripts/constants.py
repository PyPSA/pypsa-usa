...
###########################################
# Constants for EIA Powerplant Mappings
###########################################

# EIA Technology to PyPSA Carrier mapping
EIA_TECH_MAP = {
    "Technology": [
        "Petroleum Liquids",
...
# EIA Fuel Source to PyPSA Fuel Type mapping
EIA_FUEL_MAP = {
    "Energy Source 1": [
        "ANT",
        "BIT",
...
# EIA Prime Mover to PyPSA Prime Mover mapping
EIA_PRIMEMOVER_MAP = {
    "Prime Mover": [
        "BA",
        "CE",
