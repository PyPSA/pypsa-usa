...
if __name__ == "__main__":
    ...
    # create plots
    plot_base_capacity(n, onshore_regions, carriers, snakemake.output["capacity_map_base.pdf"], **snakemake.wildcards)
    plot_opt_capacity(n, onshore_regions, carriers, snakemake.output["capacity_map_optimized.pdf"], "greenfield", retirement_method, **snakemake.wildcards)
    plot_opt_capacity(n, onshore_regions, carriers, snakemake.output["capacity_map_optimized_brownfield.pdf"], "brownfield", retirement_method, **snakemake.wildcards)
    plot_new_capacity(n, onshore_regions, carriers, snakemake.output["capacity_map_new.pdf"], "greenfield", retirement_method, **snakemake.wildcards)
    plot_capacity_additions_bar(n, carriers, snakemake.output["capacity_additions_bar.pdf"], "greenfield", retirement_method,  **snakemake.wildcards)
    plot_costs_bar(n, carriers, snakemake.output["costs_bar.pdf"], **snakemake.wildcards)
    plot_production_bar(n, carriers, snakemake.output["production_bar.pdf"], **snakemake.wildcards)
    plot_production_area(n, carriers, snakemake.output["production_area.pdf"], **snakemake.wildcards)
    plot_production_html(n, carriers, snakemake.output["production_area.html"], **snakemake.wildcards)
    plot_hourly_emissions(n, snakemake.output["emissions_area.pdf"], **snakemake.wildcards)
    plot_hourly_emissions_html(n, snakemake.output["emissions_area.html"], **snakemake.wildcards)
    plot_accumulated_emissions(n, snakemake.output["emissions_accumulated.pdf"], **snakemake.wildcards)
    plot_accumulated_emissions_tech(n, snakemake.output["emissions_accumulated_tech.pdf"], **snakemake.wildcards)
    plot_accumulated_emissions_tech_html(n, snakemake.output["emissions_accumulated_tech.html"], **snakemake.wildcards)
    # plot_node_emissions_html(n, snakemake.output["emissions_node.html"], **snakemake.wildcards)
    plot_region_emissions_html(n, snakemake.output["emissions_region.html"], **snakemake.wildcards)
    plot_emissions_map(n, onshore_regions, snakemake.output["emissions_map.pdf"], **snakemake.wildcards)
    plot_renewable_potential(n, onshore_regions, snakemake.output["renewable_potential_map.pdf"], **snakemake.wildcards)
