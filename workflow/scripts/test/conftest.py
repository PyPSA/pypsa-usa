...
def base_network():
    ...
    n.buses.loc["bus1", "region"] = "west"
    n.buses.loc["bus2", "region"] = "east"
    n.buses.loc["bus3", "region"] = "east"
    n.buses.loc["bus1", "nerc_reg"] = "NERC1"
    n.buses.loc["bus2", "nerc_reg"] = "NERC2"
    n.buses.loc["bus3", "nerc_reg"] = "NERC2"
    n.buses.loc["bus1", "reeds_state"] = "CA"
    n.buses.loc["bus2", "reeds_state"] = "TX"
    n.buses.loc["bus3", "reeds_state"] = "TX"
    n.buses.loc["bus1", "reeds_zone"] = "CA_Z1"
    n.buses.loc["bus2", "reeds_zone"] = "TX_Z1"
    n.buses.loc["bus3", "reeds_zone"] = "TX_Z1"
...
def erm_multi_region_config():
    """Create a config dictionary with ERM settings for multiple regions."""
